...
reg   [0:0] icmp_ln302_reg_235;
reg   [0:0] icmp_ln174_reg_239;
reg    Input_r_blk_n;
reg    Output_r_blk_n;
reg    Output_out_blk_n;
reg    input_stream_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln302_reg_235_pp0_iter1_reg;
reg   [16:0] Y_reg_125;
reg   [503:0] shiftreg_i_i_i_i_reg_136;
reg   [57:0] trunc_ln_i_reg_219;
wire   [16:0] add_ln302_fu_177_p2;
reg    ap_enable_reg_pp0_iter0;
wire    ap_block_state72_pp0_stage0_iter0;
reg    ap_predicate_op187_read_state73;
reg    ap_block_state73_pp0_stage0_iter1;
reg    ap_block_state74_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
wire   [0:0] icmp_ln302_fu_183_p2;
wire   [0:0] icmp_ln174_fu_193_p2;
reg   [0:0] icmp_ln174_reg_239_pp0_iter1_reg;
reg   [511:0] p0_addr_read_reg_243;
wire    ap_CS_fsm_state71;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_flush_enable;
reg    ap_condition_pp0_exit_iter1_state73;
reg   [511:0] ap_phi_mux_empty_36_phi_fu_151_p4;
wire   [511:0] ap_phi_reg_pp0_iter2_empty_36_reg_148;
wire   [511:0] shiftreg_cast_i_i_i_i_fu_199_p1;
wire  signed [63:0] sext_ln302_fu_167_p1;
reg    ap_block_state1;
reg    ap_block_pp0_stage0_01001;
wire   [5:0] empty_35_fu_189_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if (((1'b1 == ap_CS_fsm_state71) | ((ap_enable_reg_pp0_iter0 == 1'b0) & (1'b1 == ap_condition_pp0_exit_iter1_state73) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_condition_pp0_exit_iter1_state73) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state71)) begin
        Y_reg_125 <= 17'd0;
    end else if (((icmp_ln302_fu_183_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state71)) begin
        shiftreg_i_i_i_i_reg_136 <= 504'd0;
    end else if (((icmp_ln302_reg_235_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        shiftreg_i_i_i_i_reg_136 <= {{ap_phi_mux_empty_36_phi_fu_151_p4[511:8]}};
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln302_fu_183_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_predicate_op187_read_state73 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        trunc_ln_i_reg_219 <= {{Input_r_dout[63:6]}};
    end
end
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0) | (1'b0 == Output_out_full_n) | (1'b0 == Output_r_empty_n) | (1'b0 == Input_r_empty_n)) & (1'b1 == ap_CS_fsm_state1))) begin
        Input_r_read = 1'b1;
    end else begin
        Input_r_read = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln302_fu_183_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if ((icmp_ln302_reg_235_pp0_iter1_reg == 1'd0)) begin
        if ((icmp_ln174_reg_239_pp0_iter1_reg == 1'd0)) begin
            ap_phi_mux_empty_36_phi_fu_151_p4 = shiftreg_cast_i_i_i_i_fu_199_p1;
        end else if ((icmp_ln174_reg_239_pp0_iter1_reg == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln302_reg_235_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln302_reg_235_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (m_axi_p0_ARREADY == 1'b1))) begin
...
always @ (*) begin
    if (((ap_predicate_op187_read_state73 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln174_reg_239 == 1'd1) & (icmp_ln302_reg_235 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
assign Output_out_din = Output_r_dout;

assign add_ln302_fu_177_p2 = (Y_reg_125 + 17'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_predicate_op187_read_state73 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_p0_RVALID == 1'b0)) | ((icmp_ln302_reg_235_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (input_stream_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_predicate_op187_read_state73 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_p0_RVALID == 1'b0)) | ((icmp_ln302_reg_235_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (input_stream_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_predicate_op187_read_state73 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_p0_RVALID == 1'b0)) | ((icmp_ln302_reg_235_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (input_stream_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (real_start == 1'b0) | (1'b0 == Output_out_full_n) | (1'b0 == Output_r_empty_n) | (1'b0 == Input_r_empty_n));
end

assign ap_block_state72_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state73_pp0_stage0_iter1 = ((ap_predicate_op187_read_state73 == 1'b1) & (m_axi_p0_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state74_pp0_stage0_iter2 = ((icmp_ln302_reg_235_pp0_iter1_reg == 1'd0) & (input_stream_full_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign ap_phi_reg_pp0_iter2_empty_36_reg_148 = 'bx;

always @ (*) begin
    ap_predicate_op187_read_state73 = ((icmp_ln174_reg_239 == 1'd1) & (icmp_ln302_reg_235 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign empty_35_fu_189_p1 = Y_reg_125[5:0];

assign icmp_ln174_fu_193_p2 = ((empty_35_fu_189_p1 == 6'd0) ? 1'b1 : 1'b0);

assign icmp_ln302_fu_183_p2 = ((Y_reg_125 == 17'd129600) ? 1'b1 : 1'b0);

assign input_stream_din = ap_phi_mux_empty_36_phi_fu_151_p4[7:0];

assign m_axi_p0_ARADDR = sext_ln302_fu_167_p1;
...
assign m_axi_p0_ARLEN = 32'd2025;
...
assign sext_ln302_fu_167_p1 = $signed(trunc_ln_i_reg_219);

assign shiftreg_cast_i_i_i_i_fu_199_p1 = shiftreg_i_i_i_i_reg_136;

assign start_out = real_start;

endmodule //Filter_HW_stream_load3
