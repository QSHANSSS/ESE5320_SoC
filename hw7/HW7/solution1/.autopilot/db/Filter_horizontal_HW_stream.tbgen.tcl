set moduleName Filter_horizontal_HW_stream
set isTopModule 0
...
set C_modelName {Filter_horizontal_HW_stream}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_stream int 8 regular {fifo 0 volatile } {global 0}  }
	{ temp_stream int 8 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_stream", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "temp_stream", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ temp_stream_din sc_out sc_lv 8 signal 1 } 
	{ temp_stream_full_n sc_in sc_logic 1 signal 1 } 
	{ temp_stream_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "temp_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	temp_stream { ap_fifo {  { temp_stream_din fifo_data 1 8 }  { temp_stream_full_n fifo_status 0 1 }  { temp_stream_write fifo_update 1 1 } } }
}
