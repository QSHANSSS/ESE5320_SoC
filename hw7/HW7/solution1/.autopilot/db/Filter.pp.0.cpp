...
# 2 "Filter.cpp" 2
# 1 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/stdlib.h" 1 3
# 36 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/stdlib.h" 3
...
# 42 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cstdlib" 2 3
...
# 37 "/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/stdlib.h" 2 3
...
{
  int X, Y, i;
  VITIS_LOOP_12_1: for (Y = 0; Y < ((540) / 2); Y++)
    VITIS_LOOP_13_2: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++)
    {
      unsigned int Sum = 0;
      VITIS_LOOP_16_3: for (i = 0; i < (7); i++)
...
{
  int X, Y, i;
  VITIS_LOOP_26_1: for (Y = 0; Y < (((540) / 2) - ((7) - 1)); Y++)
    VITIS_LOOP_27_2: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++)
    {
      unsigned int Sum = 0;
      VITIS_LOOP_30_3: for (i = 0; i < (7); i++)
...
void Filter_SW(const unsigned char * Input,
            unsigned char * Output)
{
  unsigned char * Temp = (unsigned char *) malloc(((540) / 2) * (((960) / 2) - ((7) - 1)));
...
void Filter_horizontal_HW(const unsigned char * Input,unsigned char * Output)
{
    ...
    int X, Y, i;
    VITIS_LOOP_83_1: for (Y = 0; Y < ((540) / 2); Y++)
    {
     VITIS_LOOP_85_2: for (int j = 0; j<((7)-1); j++)
     {
#pragma HLS Unroll
 temp[j] = Input[Y*((960) / 2) + j];
     }
     VITIS_LOOP_90_3: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++)
     {
#pragma HLS PIPELINE II=1
 temp[(7)-1] = Input[Y*((960) / 2) + X + ((7)-1)];
      unsigned int Sum = 0;
      VITIS_LOOP_95_4: for (i = 0; i < (7); i++)
      {
#pragma HLS PIPELINE II=1
 Sum += Coefficients[i] * temp[i];
      }
      Output[Y * (((960) / 2) - ((7) - 1)) + X] = Sum >> 8;
      VITIS_LOOP_101_5: for (int j =0; j<((7)-1); j++)
      {
#pragma HLS Unroll
 temp[j] = temp[j+1];
      }
...
void Filter_vertical_HW(const unsigned char * Input,unsigned char * Output)
{
    unsigned char temp[7];
    int X, Y, i;
    VITIS_LOOP_114_1: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++)
    {
     VITIS_LOOP_116_2: for (int j = 0; j<((7)-1); j++)
     {
#pragma HLS Unroll
 temp[j] = Input[X + j*(((960) / 2) - ((7) - 1))];
     }
     VITIS_LOOP_121_3: for (Y = 0; Y < (((540) / 2) - ((7) - 1)); Y++)
     {
#pragma HLS PIPELINE II=1
 temp[(7)-1] = Input[X + (((960) / 2) - ((7) - 1)) *((7)-1+Y)];
      unsigned int Sum = 0;
      VITIS_LOOP_126_4: for (i = 0; i < (7); i++)
      {
#pragma HLS PIPELINE II=1
 Sum += Coefficients[i] * temp[i];
      }
      Output[Y * (((960) / 2) - ((7) - 1)) + X] = Sum >> 8;
      VITIS_LOOP_132_5: for (int j =0; j<((7)-1); j++)
      {
#pragma HLS Unroll
 temp[j] = temp[j+1];
      }
...
void Filter_HW(const unsigned char * Input,
            unsigned char * Output)
{
  unsigned char Temp [((540) / 2) * (((960) / 2) - ((7) - 1))];
...
void Filter_horizontal_HW_stream(hls::stream <unsigned char> &input_stream,hls::stream <unsigned char> &temp_stream)
{
    ...
    VITIS_LOOP_155_1: for (Y = 0; Y < ((540) / 2); Y++)
    {
     VITIS_LOOP_157_2: for (int j = 0; j<((7)-1); j++)
     {
#pragma HLS Unroll
 temp[j] = input_stream.read();
     }
     VITIS_LOOP_162_3: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++)
     {
#pragma HLS PIPELINE II=1
 temp[(7)-1] = input_stream.read();
      unsigned int Sum = 0;
      VITIS_LOOP_167_4: for (i = 0; i < (7); i++)
      {
#pragma HLS Unroll
 Sum += Coefficients[i] * temp[i];
      }
      temp_stream.write(Sum >> 8);
      VITIS_LOOP_173_5: for (int j =0; j<((7)-1); j++)
      {
#pragma HLS Unroll
 temp[j] = temp[j+1];
      }
...
#pragma HLS DATAFLOW
 unsigned char temp[7];
    ...
    VITIS_LOOP_188_1: for (Y = 0; Y < ((540) / 2); Y++)
    {
     VITIS_LOOP_190_2: for (int j = 0; j<((7)-1); j++)
     {
#pragma HLS Unroll
 temp[j] = Input[j + Y * ((960) / 2)];
     }

     VITIS_LOOP_196_3: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++)
     {
#pragma HLS PIPELINE II=1
 temp[(7)-1] = Input[Y * ((960) / 2) + X + ((7)-1)];
      unsigned int Sum = 0;
      VITIS_LOOP_201_4: for (i = 0; i < (7); i++)
      {
#pragma HLS Unroll
 Sum += Coefficients[i] * temp[i];
      }
      temp_stream.write(Sum >> 8);
      VITIS_LOOP_207_5: for (int j =0; j<((7)-1); j++)
      {
#pragma HLS Unroll
 temp[j] = temp[j+1];
      }
...
void Filter_vertical_HW_stream(hls::stream <unsigned char> &temp_stream, hls::stream <unsigned char> &output_stream)
{
 ...
 int X, Y, i, j;
 unsigned char temp[7][(((960) / 2) - ((7) - 1))];
#pragma HLS array_partition variable=temp complete dim=1
# 232 "Filter.cpp"
 VITIS_LOOP_232_1: for (Y = 0; Y < (((540) / 2) - ((7) - 1)) + 6; Y++)
    {
     VITIS_LOOP_234_2: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++)
     {
      if (Y < 6) {
    ...
    unsigned int Sum = 0;
    temp[(7)-1][X] = temp_stream.read();

    VITIS_LOOP_243_3: for (i = 0; i < (7); i++)
    {
#pragma HLS Unroll
 Sum += Coefficients[i] * temp[i][X];
    }
    output_stream.write(Sum >> 8);
    VITIS_LOOP_249_4: for (int j =0; j<((7)-1); j++)
    {
#pragma HLS Unroll
 temp[j][X] = temp[j+1][X];
    }
...
#pragma HLS array_partition variable=temp complete dim=1
# 274 "Filter.cpp"
 VITIS_LOOP_274_1: for (Y = 0; Y < (((540) / 2) - ((7) - 1)) + 6; Y++)
    {
     VITIS_LOOP_276_2: for ( X = 0; X < (((960) / 2) - ((7) - 1)); X++)
     {
      if (Y < 6) {
       temp[Y][X] = temp_stream.read();
      }
          ...
          unsigned int Sum = 0;
          temp[(7)-1][X] = temp_stream.read();
          VITIS_LOOP_284_3: for (i = 0; i < (7); i++)
          {
#pragma HLS Unroll
 Sum += Coefficients[i] * temp[i][X];
          }
          Output[(Y-6) * (((960) / 2) - ((7) - 1)) + X]=Sum >> 8;

          VITIS_LOOP_291_4: for (int j =0; j<((7)-1); j++)
          {
#pragma HLS Unroll
 temp[j][X] = temp[j+1][X];
          }
...
void load(unsigned char * Input, hls::stream <unsigned char> &input_stream) {
  VITIS_LOOP_302_1: for (int Y=0; Y<((540) / 2) * ((960) / 2); Y++)
...
void store(hls::stream <unsigned char> &output_stream, unsigned char * Output) {
  VITIS_LOOP_314_1: for (int Y=0; Y<(((540) / 2) - ((7) - 1)) * (((960) / 2) - ((7) - 1)); Y++)
   Output[Y]=output_stream.read();
}

__attribute__((sdx_kernel("Filter_HW_stream", 0))) void Filter_HW_stream(unsigned char * Input, unsigned char * Output)
{
#pragma HLS TOP name=Filter_HW_stream
# 319 "Filter.cpp"

#pragma HLS DATAFLOW
#pragma HLS INTERFACE m_axi port=Input offset=slave bundle=p0 depth=129600
