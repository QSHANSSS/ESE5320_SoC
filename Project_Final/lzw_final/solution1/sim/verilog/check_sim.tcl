...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.encoding.autotvin_p0.dat"
         "c.encoding.autotvin_p1.dat"
         "c.encoding.autotvin_buff.dat"
         "c.encoding.autotvin_input_length.dat"
         "c.encoding.autotvin_output_compress.dat"
         "c.encoding.autotvin_output_length.dat"
         "c.encoding.autotvout_p2.dat"
         "c.encoding.autotvout_p3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.encoding.autotvout_p2.dat"
         "rtl.encoding.autotvout_p3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
