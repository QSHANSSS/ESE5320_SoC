...
if {[file isfile encoding.autotvin.dat]} {
	file delete -force encoding.autotvin.dat
}

if {[file isfile encoding.autotvout.dat]} {
	file delete -force encoding.autotvout.dat
}
