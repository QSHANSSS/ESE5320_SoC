...
//------------------------Parameter----------------------
`define TV_IN_p2 "../tv/cdatafile/c.encoding.autotvin_p2.dat"
`define TV_OUT_p2 "../tv/rtldatafile/rtl.encoding.autotvout_p2.dat"
 parameter p2_ADDR_BITWIDTH = 32'd 64;
 parameter p2_AWUSER_BITWIDTH = 32'd 1;
 parameter p2_DATA_BITWIDTH = 32'd 32;
 parameter p2_WUSER_BITWIDTH = 32'd 1;
 parameter p2_ID_BITWIDTH = 32'd 1;
 parameter p2_RUSER_BITWIDTH = 32'd 1;
 parameter p2_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   64 + 64;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter p2_C_DATA_BITWIDTH = 32'd 16;
parameter p2_mem_depth = 32'd 8192;
parameter ReadReqLatency = 32'd 64;
parameter WriteReqLatency = 32'd 64;
// Input and Output
input clk;
input reset;
input  TRAN_p2_AWVALID;
output  TRAN_p2_AWREADY;
input [p2_ADDR_BITWIDTH - 1 : 0] TRAN_p2_AWADDR;
input [p2_ID_BITWIDTH - 1 : 0] TRAN_p2_AWID;
input [8 - 1 : 0] TRAN_p2_AWLEN;
input [3 - 1 : 0] TRAN_p2_AWSIZE;
input [2 - 1 : 0] TRAN_p2_AWBURST;
input [2 - 1 : 0] TRAN_p2_AWLOCK;
input [4 - 1 : 0] TRAN_p2_AWCACHE;
input [3 - 1 : 0] TRAN_p2_AWPROT;
input [4 - 1 : 0] TRAN_p2_AWQOS;
input [4 - 1 : 0] TRAN_p2_AWREGION;
input [p2_AWUSER_BITWIDTH - 1 : 0] TRAN_p2_AWUSER;
input  TRAN_p2_WVALID;
output  TRAN_p2_WREADY;
input [p2_DATA_BITWIDTH - 1 : 0] TRAN_p2_WDATA;
input [p2_DATA_BITWIDTH/8 - 1 : 0] TRAN_p2_WSTRB;
input  TRAN_p2_WLAST;
input  TRAN_p2_WID;
input [p2_WUSER_BITWIDTH - 1 : 0] TRAN_p2_WUSER;
input  TRAN_p2_ARVALID;
output  TRAN_p2_ARREADY;
input [p2_ADDR_BITWIDTH - 1 : 0] TRAN_p2_ARADDR;
input [p2_ID_BITWIDTH - 1 : 0] TRAN_p2_ARID;
input [8 - 1 : 0] TRAN_p2_ARLEN;
input [3 - 1 : 0] TRAN_p2_ARSIZE;
input [2 - 1 : 0] TRAN_p2_ARBURST;
input [2 - 1 : 0] TRAN_p2_ARLOCK;
input [4 - 1 : 0] TRAN_p2_ARCACHE;
input [3 - 1 : 0] TRAN_p2_ARPROT;
input [4 - 1 : 0] TRAN_p2_ARQOS;
input [4 - 1 : 0] TRAN_p2_ARREGION;
input  TRAN_p2_ARUSER;
output  TRAN_p2_RVALID;
input  TRAN_p2_RREADY;
output [p2_DATA_BITWIDTH - 1 : 0] TRAN_p2_RDATA;
output  TRAN_p2_RLAST;
output [p2_ID_BITWIDTH - 1 : 0] TRAN_p2_RID;
output [p2_RUSER_BITWIDTH - 1 : 0] TRAN_p2_RUSER;
output [2 - 1 : 0] TRAN_p2_RRESP;
output  TRAN_p2_BVALID;
input  TRAN_p2_BREADY;
output [2 - 1 : 0] TRAN_p2_BRESP;
output [p2_ID_BITWIDTH - 1 : 0] TRAN_p2_BID;
output [p2_BUSER_BITWIDTH - 1 : 0] TRAN_p2_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [p2_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [p2_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [p2_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [p2_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [p2_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [p2_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [p2_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [p2_DATA_BITWIDTH - 1 : 0] p2_mem_0 [0: p2_mem_depth - 1]; 
reg [p2_DATA_BITWIDTH - 1 : 0] p2_mem_1 [0: p2_mem_depth - 1]; 
reg [p2_DATA_BITWIDTH - 1 : 0] p2_mem_2 [0: p2_mem_depth - 1]; 
reg [p2_DATA_BITWIDTH - 1 : 0] p2_mem_3 [0: p2_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [p2_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [p2_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [p2_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_p2_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_p2_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_p2_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_p2_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_p2_BRESP = BRESP_tmp;
assign TRAN_p2_RDATA = RDATA_tmp;
assign TRAN_p2_RRESP = RRESP_tmp;
assign TRAN_p2_RLAST = RLAST_tmp;
assign TRAN_p2_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = p2_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
end

initial begin : initialize_p2_mem
  integer i;
  for (i = 0; i < p2_mem_depth; i = i + 1) begin
      p2_mem_0[i] = 0;
      p2_mem_1[i] = 0;
      p2_mem_2[i] = 0;
      p2_mem_3[i] = 0;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_p2_AWREADY & TRAN_p2_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_p2_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_p2_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_p2_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_p2_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_p2_ARREADY & TRAN_p2_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_p2_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_p2_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_p2_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_p2_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_p2_WREADY & TRAN_p2_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_p2_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_p2_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_p2_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_p2_AWVALID && TRAN_p2_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_p2_ARVALID && TRAN_p2_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_p2_WVALID && TRAN_p2_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_p2_WVALID && TRAN_p2_WREADY && TRAN_p2_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_p2_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_p2_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [p2_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [p2_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [p2_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > p2_mem_depth) begin
                $display ("/mnt/castor/seas_home/q/qiansh/Documents/532_prj/lzw_final/solution1/sim/verilog/AESL_axi_master_p2.v: Write request address %d exceed AXI master p2 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, p2_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = p2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = p2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = p2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = p2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : p2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : p2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : p2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : p2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = p2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = p2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = p2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = p2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : p2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : p2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : p2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : p2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > p2_mem_depth) begin
                $display ("/mnt/castor/seas_home/q/qiansh/Documents/532_prj/lzw_final/solution1/sim/verilog/AESL_axi_master_p2.v: Read request address %d exceed AXI master p2 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, p2_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= p2_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= p2_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= p2_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= p2_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_p2_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= p2_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= p2_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= p2_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= p2_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [p2_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [p2_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  p2_bitwidth = p2_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (p2_bitwidth , factor);
  fp = $fopen(`TV_IN_p2,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_p2); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [p2_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < p2_mem_depth; i = i + 1) begin 
          token = read_token(fp);
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : p2_mem_0[i/factor] = mem_tmp;
                      1 : p2_mem_1[i/factor] = mem_tmp;
                      2 : p2_mem_2[i/factor] = mem_tmp;
                      3 : p2_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : p2_mem_0[i] = mem_tmp;
                  1 : p2_mem_1[i] = mem_tmp;
                  2 : p2_mem_2[i] = mem_tmp;
                  3 : p2_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [p2_DATA_BITWIDTH - 1: 0] = 0;
          end
...
initial begin : write_file_proc 
  ...
  integer mem_page; 
  integer p2_bitwidth; 
  reg [p2_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [p2_DATA_BITWIDTH - 1 : 0] tmp_data;
  transaction_num = 0; 
  p2_bitwidth = p2_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (p2_bitwidth , factor);
  while(1) begin 
      ...
      mem_page = transaction_num % mem_page_num ;
      # 0.1;
      fp = $fopen(`TV_OUT_p2, "a"); 
      if(fp == 0) begin       // Failed to open file 
          $display("Failed to open file \"%s\"!", `TV_OUT_p2); 
          $finish; 
      end 
      $fdisplay(fp, "[[transaction]] %d", transaction_num);
      for(i = 0; i < (p2_mem_depth - p2_mem_depth % factor); i = i + 1) begin 
          if (factor == 4) begin
              case(mem_page)
                  0 : tmp_data = p2_mem_0[i/factor];
                  1 : tmp_data = p2_mem_1[i/factor];
                  2 : tmp_data = p2_mem_2[i/factor];
                  3 : tmp_data = p2_mem_3[i/factor];
          ...
          if (factor == 1) begin
              case(mem_page)
                  0 : mem_tmp = p2_mem_0[i];
                  1 : mem_tmp = p2_mem_1[i];
                  2 : mem_tmp = p2_mem_2[i];
                  3 : mem_tmp = p2_mem_3[i];
                  default: $display("The page_num of write file is not valid!");
              endcase
              $fdisplay(fp,"0x%x",mem_tmp);
          end
      ...
      if (factor == 4) begin
          case(mem_page)
              0 : tmp_data = p2_mem_0[p2_mem_depth/factor];
              1 : tmp_data = p2_mem_1[p2_mem_depth/factor];
              2 : tmp_data = p2_mem_2[p2_mem_depth/factor];
              3 : tmp_data = p2_mem_3[p2_mem_depth/factor];
              default: $display("The page_num of write file is not valid!");
          endcase
          if ((p2_mem_depth - 1) % factor == 2) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
              $fdisplay(fp,"0x%x",tmp_data[23:16]);
          end
          if ((p2_mem_depth - 1) % factor == 1) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
          end
          if ((p2_mem_depth - 1) % factor == 0) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
          end
      end
      if (factor == 2) begin
          if ((p2_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  0 : $fdisplay(fp,"0x%x",p2_mem_0[p2_mem_depth/factor][15:0]);
                  1 : $fdisplay(fp,"0x%x",p2_mem_1[p2_mem_depth/factor][15:0]);
                  2 : $fdisplay(fp,"0x%x",p2_mem_2[p2_mem_depth/factor][15:0]);
                  3 : $fdisplay(fp,"0x%x",p2_mem_3[p2_mem_depth/factor][15:0]);
                  default: $display("The page_num of write file is not valid!");
              endcase
          end
      end
