...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "encoding.autotvin.dat"
	set constFileTvOut       "encoding.autotvout.dat"
	set constFileHdlTvIn     "encoding.autohdltvin.dat"
	set constFileHdlTvOut    "encoding.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
