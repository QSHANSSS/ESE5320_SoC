...
set C_modelName {hash_func}
set C_modelType { int 14 }
set C_modelArgList {
	{ key int 8 regular {array 8192 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ key_offset sc_in sc_lv 13 signal 1 } 
	{ len sc_in sc_lv 18 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.temp_key_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	key { ap_memory {  { key_address0 mem_address 1 13 }  { key_ce0 mem_ce 1 1 }  { key_q0 mem_dout 0 8 } } }
