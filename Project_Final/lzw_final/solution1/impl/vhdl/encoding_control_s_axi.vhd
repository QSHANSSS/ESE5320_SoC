...
entity encoding_control_s_axi is
generic (
...
end entity encoding_control_s_axi;
...
architecture behave of encoding_control_s_axi is
    ...
    constant ADDR_BUFF_DATA_0            : INTEGER := 16#10#;
    constant ADDR_BUFF_DATA_1            : INTEGER := 16#14#;
    constant ADDR_BUFF_CTRL              : INTEGER := 16#18#;
    ...
    constant ADDR_OUTPUT_COMPRESS_DATA_0 : INTEGER := 16#28#;
    constant ADDR_OUTPUT_COMPRESS_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_OUTPUT_COMPRESS_CTRL   : INTEGER := 16#30#;
    ...
    signal int_buff            : UNSIGNED(63 downto 0) := (others => '0');
    signal int_input_length    : UNSIGNED(63 downto 0) := (others => '0');
    signal int_output_compress : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_BUFF_DATA_0 =>
                        rdata_data <= RESIZE(int_buff(31 downto 0), 32);
                    when ADDR_BUFF_DATA_1 =>
                        rdata_data <= RESIZE(int_buff(63 downto 32), 32);
                    ...
                    when ADDR_OUTPUT_COMPRESS_DATA_0 =>
                        rdata_data <= RESIZE(int_output_compress(31 downto 0), 32);
                    when ADDR_OUTPUT_COMPRESS_DATA_1 =>
                        rdata_data <= RESIZE(int_output_compress(63 downto 32), 32);
...
-- ----------------------- Register logic ----------------
    ...
    buff                 <= STD_LOGIC_VECTOR(int_buff);
    input_length         <= STD_LOGIC_VECTOR(int_input_length);
    output_compress      <= STD_LOGIC_VECTOR(int_output_compress);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BUFF_DATA_0) then
                    int_buff(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_buff(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BUFF_DATA_1) then
                    int_buff(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_buff(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OUTPUT_COMPRESS_DATA_0) then
                    int_output_compress(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_output_compress(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OUTPUT_COMPRESS_DATA_1) then
                    int_output_compress(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_output_compress(63 downto 32));
                end if;
            end if;
        end if;
    end process;
